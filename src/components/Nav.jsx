...
const Nav = () => {
  ...
  return (
    <nav
      className={`flex justify-between bg-primary-100 items-center p-4 md:px-24  shadow-[0_2px_1px_0_rgba(214,214,214,0.75)] dark:shadow-[0_2px_1px_0_rgba(148,148,156,0.75)] dark:bg-dark-700`}
    >
